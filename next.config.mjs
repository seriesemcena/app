...
const csp = [
  "default-src 'self'",
  `script-src 'self' 'unsafe-inline' https://www.recaptcha.net https://www.gstatic.com https://challenges.cloudflare.com${isDev ? " 'unsafe-eval'" : ''}`,
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' data: https://fonts.gstatic.com",
  "img-src 'self' data: blob: https:",
  "media-src 'self' https:",
  `connect-src 'self' https://*.googleapis.com https://*.google.com https://*.cloudfunctions.net https://api.tvmaze.com https://www.recaptcha.net https://challenges.cloudflare.com${isDev ? ' ws: wss:' : ''}`,
  "frame-src 'self' https://*.firebaseapp.com https://accounts.google.com https://appleid.apple.com https://www.recaptcha.net https://challenges.cloudflare.com",
