...
function ReviewsPageInner() {
  ...
  const title      = sp.get('title') || 'Avaliações';
  ...
  const submitReview = async () => {
    if (modalRating === 0 && !comment.trim()) { showToast('Adicione nota ou comentário'); return; }
        ...
        <ScrollArea>
          ...
          >
            <div style={{ textAlign: 'center' }}>
              <div style={{ fontSize: 15, fontWeight: 800, color: '#fff', fontFamily: "'Area',sans-serif" }}>Avaliações</div>
              {showName && (
          ...
          <div style={{ padding: '16px 16px 0' }}>
            ...
            {sorted.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '48px 0' }}>
                ...
                <Txt size={15} weight={700} color={T.t2} style={{ display: 'block', marginTop: 14, marginBottom: 6 }}>Sem avaliações ainda</Txt>
                ...
                <button onClick={() => setModalOpen(true)}
                  ...
                  <Txt size={14} weight={700} color="#fff">Avaliar agora</Txt>
                </button>
              </div>
            ) : (
                ...
                <div style={{ marginBottom: 16, textAlign: 'center' }}>
                  ...
                  {modalRating > 0 && (
                    <Txt size={13} weight={700} color={T.pink} style={{ display: 'block', marginTop: 6 }}>
                      {['', 'Ruim', 'Regular', 'Bom', 'Ótimo', 'Obra-prima'][modalRating]}
                    </Txt>
                  )}
                </div>
                <textarea
